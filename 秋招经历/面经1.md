...
+  数据链路层：定义数据的基本格式，封装成帧，进行透明传输；如网卡MAC地址。 传输的数据称为帧![截屏2021-09-10 上午10.15.38](../../../../Library/Application Support/typora-user-images/截屏2021-09-10 上午10.15.38.png)
...
##### 5.为什么要有用户态和内核态，哪些操作会是用户态切换到内核态
