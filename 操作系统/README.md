...
+ [操作系统简介篇](#操作系统简介篇)
  ...
  + [1.什么是操作系统](#1什么是操作系统)
  + [2.操作系统的主要功能](#2操作系统的主要功能)
  + [3.软件访问硬件的几种方式](#3软件访问硬件的几种方式)
  + [4.解释一下操作系统的主要目的是什么](#4解释一下操作系统的主要目的是什么)
  + [5.为什么 Linux 系统下的应用程序不能直接在 Windows 下运行](#5为什么-linux-系统下的应用程序不能直接在-windows-下运行)
  + [6.操作系统结构](#6操作系统结构)
  + [7.为什么称为陷入内核](#7为什么称为陷入内核)
  + [8.什么是用户态和内核态](#8什么是用户态和内核态)
  + [9.用户态和内核态是如何切换的？](#9用户态和内核态是如何切换的)
  + [10.什么是内核](#10什么是内核)
  + [11.什么是实时系统](#11什么是实时系统)
  + [12.Linux 操作系统的启动过程](#12linux-操作系统的启动过程)

+ [进程与线程篇](#进程与线程篇)

  + [1.多处理系统的优势](#1多处理系统的优势)
  + [2.什么是进程和进程表](#2什么是进程和进程表)
  + [3.什么是线程，线程和进程的区别](#3什么是线程线程和进程的区别)
  + [4.什么是上下文切换](#4什么是上下文切换)
  + [5. 使用多线程的好处是什么](#5-使用多线程的好处是什么)
  + [6.进程终止的方式](#6进程终止的方式)
  + [7.进程间的通信方式](#7进程间的通信方式)
  + [8.进程间状态模型](#8进程间状态模型)
  + [9.调度算法都有哪些](#9调度算法都有哪些)
  + [10.交互式系统中的调度](#10交互式系统中的调度)
  + [11.影响调度程序的指标是什么](#11影响调度程序的指标是什么)
  + [12.什么是 RR 调度算法](#12什么是-rr-调度算法)

+ [内存管理篇](#内存管理篇)

  + [1.什么是按需分页](#1什么是按需分页)
  + [2.什么是虚拟内存](#2什么是虚拟内存)
  + [3.虚拟内存的实现方式](#3虚拟内存的实现方式)
  + [4.内存为什么要分段](#4内存为什么要分段)
  + [5.物理地址、逻辑地址、有效地址、线性地址、虚拟地址的区别](#5物理地址逻辑地址有效地址线性地址虚拟地址的区别)
  + [6.空闲内存管理的方式](#6空闲内存管理的方式)
  + [7.页面置换算法都有哪些](#7页面置换算法都有哪些)

+ [文件系统篇](#文件系统篇)

  + [1.提高文件系统性能的方式](#1提高文件系统性能的方式)
  + [2.磁盘臂调度算法](#2磁盘臂调度算法)

  + [3.RAID 的不同级别](#3raid-的不同级别)

+ [IO篇](#io篇)

  + [1.操作系统中的时钟是什么](#1操作系统中的时钟是什么)
  + [2.设备控制器的主要功能](#2设备控制器的主要功能)
  + [3.中断处理过程](#3中断处理过程)
  + [4.什么是设备驱动程序](#4什么是设备驱动程序)
  + [5.什么是 DMA](#5什么是-dma)
  + [6.直接内存访问的特点](#6直接内存访问的特点)

+ [死锁篇](#死锁篇)

  + [1.什么是僵尸进程](#1什么是僵尸进程)
  + [2.死锁产生的原因](#2死锁产生的原因)
  + [3.死锁产生的必要条件](#3死锁产生的必要条件)
  + [4.死锁的恢复方式](#4死锁的恢复方式)
  + [5.如何破坏死锁](#5如何破坏死锁)
  + [6.死锁类型](#6死锁类型)
